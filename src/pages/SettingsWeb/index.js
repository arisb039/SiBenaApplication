...
import { Column, Row, Img, Text, Button, List, Switch, Line } from "components";
import { useNavigate } from "react-router-dom";

const SettingsWebPage = () => {
      ...
      <Column className="bg-white_A700 flex flex-col font-plusjakartasans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start w-[100%]">
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[1096px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              ...
              <Column className="flex flex-col font-opensans items-center justify-start md:ml-[236px] ml-[344px] sm:mt-[36px] md:mt-[46px] mt-[68px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[44%]">
                <Text
                ...
                <List
                  className="font-poppins md:gap-[11px] gap-[16px] sm:gap-[8px] grid min-h-[auto] sm:mt-[34px] md:mt-[44px] mt-[64px] w-[100%]"
                  orientation="vertical"
                >
                  <Column
                    className="bg-cover bg-no-repeat flex flex-col items-center justify-end p-[10px] sm:p-[5px] md:p-[6px] w-[100%]"
                    style={{
                      backgroundImage: "url('images/img_group636.svg')",
                    }}
                  >
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[96%]">
                      <Text
                      ...
                      <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[8%]">
                        <Switch value={false} className="w-[100%]" />
                      </Column>
                    </Row>
                  </Column>
                  <Column
